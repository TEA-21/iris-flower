...
hist_list=st.sidebar.multiselect('Select the feature to create histogram',('RI', 'Na', 'Mg', 'Al', 'Si', 'K', 'Ca', 'Ba', 'Fe'))
for i in hist_list:
...
box_list=st.sidebar.multiselect('Select the feature to create boxplot',('RI', 'Na', 'Mg', 'Al', 'Si', 'K', 'Ca', 'Ba', 'Fe'))
for i in box_list:
  st.subheader(f'Boxplot for {i}')
  plt.figure(figsize=(13,7))
  sns.boxplot(glass_df[i],color='red',orient='h')
  st.pyplot()